...
function Writer({adminBarHtml, menu, options, latestPosts, allPosts, writer, pageNumber}: {adminBarHtml: any, menu: any, options: any, latestPosts: any, allPosts: any, writer: any, pageNumber: number}) {
    return (
        <>
            <Head>
