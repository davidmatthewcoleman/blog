...
function Topic({adminBarHtml, menu, options, latestPosts, allPosts, topic, breadcrumb}: {adminBarHtml: any, menu: any, options: any, latestPosts: any, allPosts: any, topic: any, breadcrumb: any}) {
